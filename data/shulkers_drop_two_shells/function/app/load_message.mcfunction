#> shulkers_drop_two_shells:app/load_message
# Called on load

execute if score &shulkers_drop_two_shells_load_message jodek.config matches 1 run tellraw @a [\
  {\
    "text": "[",\
    "color": "#aaaaaa"\
  },\
  {\
    ...
    "hover_event": {\
      ...
      "value": [\
        {\
          "nbt":"tellraw[]",\
          "storage": "shulkers_drop_two_shells:image",\
          interpret: true,\
          separator: ""\
        }\
      ]\
